...
static const int NUM_ASTEROIDS = 150;
...
void renderScene()
{
	...
	glm::mat4 shipModelMatrix = glm::translate(cameraPos + cameraDir * 0.5f + glm::vec3(0,-0.25f,0)) * glm::rotate(-cameraAngle + glm::radians(90.0f), glm::vec3(0,200,0)) * glm::scale(glm::vec3(0.05f));
	///drawObjectColor(&shipModel, shipModelMatrix, glm::vec3(0.6f));
	drawObjectTexture(&shipModel, shipModelMatrix * glm::scale(glm::vec3(1, 1, 1)), textureAsteroid);
	...
	for (int i = 0; i < NUM_ASTEROIDS; i++)
	{
		...
		drawObjectTexture2(&sphereModel, glm::translate(asteroidPositions[i]) * glm::scale(glm::vec3(0.25,0.25,0.25)), textureAsteroid, transformation);
	}
...
void init()
{
	...
	*/
	...
	shipModel = obj::loadModelFromFile("models/obj-shark.obj");
